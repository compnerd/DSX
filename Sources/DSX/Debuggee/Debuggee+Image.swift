...
extension Debuggee {
  ...
  /// SVR4 loader coordinates; bias is a relocation displacement, not a base.
  internal struct Library: Sendable {
    internal let path: String
    internal let bias: UInt64
  ...
  internal struct Module: Sendable {
    internal enum Identity: Sendable {
      ...
      internal var value: String {
        switch self {
        case let .digest(value), let .unique(value): value
        }
      }
    }
