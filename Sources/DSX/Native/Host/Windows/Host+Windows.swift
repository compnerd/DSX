...
extension Host {
  ...
  internal static let daemonization: DaemonizationOrder = .before

  internal static let system: StaticString = "windows"
...
extension Debuggee.Process.Info {
  internal func matches(_ candidate: String) -> Bool {
    WindowsFileSystem.matches(name.utf8Span.span, candidate, component: false)
  }
}
