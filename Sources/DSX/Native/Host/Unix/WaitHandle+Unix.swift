...
extension WaitHandle {
  internal func wait(timeout: Int32, events: borrowing Span<WaitHandle>)
    ...
    return try withUnsafeTemporaryAllocation(of: pollfd.self,
      ...
      while true {
        ...
        if let deadline {
          remaining = try Int32(clamping: deadline.remaining(at: time()))
        }
      }
    })
  }
...
private func time() throws(TransportError) -> UInt64 {
  var value: UInt64 = 0
