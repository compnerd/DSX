...
internal typealias NativeEventSource = LinuxEventSource
#else
internal typealias NativeLibraryCursor = UnsupportedLibraryCursor
#if os(anyAppleOS)
internal typealias NativeEventSource = DarwinEventSource
#else
internal typealias NativeEventSource = PollingEventSource
#endif
#endif
...
internal typealias NativeProcessCursor = SnapshotProcessCursor
#if arch(arm64)
