...
internal enum WindowsDebugDisposition: Sendable {
  ...
  internal var value: DWORD {
    switch self {
    case .handled: DBG_CONTINUE
    case .unhandled: DBG_EXCEPTION_NOT_HANDLED
    case .deferred: DBG_REPLY_LATER
    }
  }
}
...
extension WindowsDebugDisposition {
  ...
  internal init?(_ event: borrowing DEBUG_EVENT) {
    ...
    switch code {
    case EXCEPTION_BREAKPOINT, EXCEPTION_SINGLE_STEP, STATUS_WX86_BREAKPOINT,
