...
internal struct X86BreakpointControl: Sendable {
  ...
  // Slot operations receive a comparator index in 0 ..< 4, so every bit
  // offset fits the register width without general shift-range handling.
  @_transparent
