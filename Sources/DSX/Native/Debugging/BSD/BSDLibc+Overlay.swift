...
#if os(FreeBSD)
@_transparent
internal var PT_LWPINFO: CInt {
  CInt(Glibc.PT_LWPINFO)
}

@_transparent
internal var PT_SETSTEP: CInt {
  CInt(Glibc.PT_SETSTEP)
}

@_transparent
internal var PT_CLEARSTEP: CInt {
  CInt(Glibc.PT_CLEARSTEP)
}

@_transparent
internal var PT_SUSPEND: CInt {
  CInt(Glibc.PT_SUSPEND)
}

@_transparent
internal var PT_RESUME: CInt {
  CInt(Glibc.PT_RESUME)
}
...
#elseif os(OpenBSD)
@_transparent
internal var PT_GET_PROCESS_STATE: CInt {
  CInt(Glibc.PT_GET_PROCESS_STATE)
}
