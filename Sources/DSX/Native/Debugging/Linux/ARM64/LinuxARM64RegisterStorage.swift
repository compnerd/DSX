...
extension LinuxRegisterState {
  internal func read(_ register: RegisterIdentifier,
    ...
    case 32:
      try output.append(general.pc, size: 8)
    case 33:
    ...
    case 165 ... 166:
      ...
      let mask = register.rawValue == 165 ? masks.data : masks.instruction
      try output.append(mask, size: 8)
    default:
      throw .register
    }
  }
  ...
  internal mutating func write(_ register: RegisterIdentifier,
    ...
    case 32:
      general.pc = try bytes.register(as: UInt64.self)
    case 33:
