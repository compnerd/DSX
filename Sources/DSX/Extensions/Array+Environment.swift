...
extension Array where Element == NativeEnvironment.Unit {
  internal init(_ changes: borrowing Span<Debuggee.Environment>,
                inheriting storage: consuming Array<Element>)
    ...
    self = storage.withUnsafeBufferPointer { storage in
