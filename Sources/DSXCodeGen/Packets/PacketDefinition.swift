...
internal struct PacketDefinition: Decodable {
  ...
  internal init(from decoder: Decoder) throws {
    ...
    availability =
        try PacketAvailability(feature: feature, compatibility: compatibility)
    scope =
...
internal enum PacketLeaf: Hashable {
  ...
  internal var expression: String {
    ...
    case let .transfer(name): ".transfer(.\(name))"
    }
  }
}
